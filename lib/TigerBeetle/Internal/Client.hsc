...
newtype AccountFlags = AccountFlags Word16 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
accountFlagName :: AccountFlags -> String
accountFlagName ACCOUNT_LINKED = "ACCOUNT_LINKED"
accountFlagName ACCOUNT_DEBITS_MUST_NOT_EXCEED_CREDITS = "ACCOUNT_DEBITS_MUST_NOT_EXCEED_CREDITS"
accountFlagName ACCOUNT_CREDITS_MUST_NOT_EXCEED_DEBITS = "ACCOUNT_CREDITS_MUST_NOT_EXCEED_DEBITS"
accountFlagName ACCOUNT_HISTORY = "ACCOUNT_HISTORY"
accountFlagName ACCOUNT_IMPORTED = "ACCOUNT_IMPORTED"
accountFlagName ACCOUNT_CLOSED = "ACCOUNT_CLOSED"

instance Show AccountFlags where
  showsPrec p flags =
    let flagsSet = filter (flags `testFlags`) [ACCOUNT_LINKED, ACCOUNT_DEBITS_MUST_NOT_EXCEED_CREDITS, ACCOUNT_CREDITS_MUST_NOT_EXCEED_DEBITS, ACCOUNT_HISTORY, ACCOUNT_IMPORTED, ACCOUNT_CLOSED]
    in  case flagsSet of
          [] -> showString "zeroBits"
...
newtype TransferFlags = TransferFlags Word16 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
transferFlagName :: TransferFlags -> String
transferFlagName TRANSFER_LINKED = "TRANSFER_LINKED"
transferFlagName TRANSFER_PENDING = "TRANSFER_PENDING"
transferFlagName TRANSFER_POST_PENDING_TRANSFER = "TRANSFER_POST_PENDING_TRANSFER"
transferFlagName TRANSFER_VOID_PENDING_TRANSFER = "TRANSFER_VOID_PENDING_TRANSFER"
transferFlagName TRANSFER_BALANCING_DEBIT = "TRANSFER_BALANCING_DEBIT"
transferFlagName TRANSFER_BALANCING_CREDIT = "TRANSFER_BALANCING_CREDIT"
transferFlagName TRANSFER_CLOSING_DEBIT = "TRANSFER_CLOSING_DEBIT"
transferFlagName TRANSFER_CLOSING_CREDIT = "TRANSFER_CLOSING_CREDIT"
transferFlagName TRANSFER_IMPORTED = "TRANSFER_IMPORTED"

instance Show TransferFlags where
  showsPrec p flags =
    let flagsSet = filter (flags `testFlags`) [TRANSFER_LINKED, TRANSFER_PENDING, TRANSFER_POST_PENDING_TRANSFER, TRANSFER_VOID_PENDING_TRANSFER, TRANSFER_BALANCING_DEBIT, TRANSFER_BALANCING_CREDIT, TRANSFER_CLOSING_DEBIT, TRANSFER_CLOSING_CREDIT, TRANSFER_IMPORTED]
    in  case flagsSet of
          [] -> showString "zeroBits"
          [singleFlag] -> showString (transferFlagName singleFlag)
...
newtype CreateAccountResult = CreateAccountResult Word32 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show CreateAccountResult where
  show CREATE_ACCOUNT_OK = "CREATE_ACCOUNT_OK"
  show CREATE_ACCOUNT_LINKED_EVENT_FAILED = "CREATE_ACCOUNT_LINKED_EVENT_FAILED"
  show CREATE_ACCOUNT_LINKED_EVENT_CHAIN_OPEN = "CREATE_ACCOUNT_LINKED_EVENT_CHAIN_OPEN"
  show CREATE_ACCOUNT_IMPORTED_EVENT_EXPECTED = "CREATE_ACCOUNT_IMPORTED_EVENT_EXPECTED"
  show CREATE_ACCOUNT_IMPORTED_EVENT_NOT_EXPECTED = "CREATE_ACCOUNT_IMPORTED_EVENT_NOT_EXPECTED"
  show CREATE_ACCOUNT_TIMESTAMP_MUST_BE_ZERO = "CREATE_ACCOUNT_TIMESTAMP_MUST_BE_ZERO"
  show CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_OUT_OF_RANGE = "CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_OUT_OF_RANGE"
  show CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE = "CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE"
  show CREATE_ACCOUNT_RESERVED_FIELD = "CREATE_ACCOUNT_RESERVED_FIELD"
  show CREATE_ACCOUNT_RESERVED_FLAG = "CREATE_ACCOUNT_RESERVED_FLAG"
  show CREATE_ACCOUNT_ID_MUST_NOT_BE_ZERO = "CREATE_ACCOUNT_ID_MUST_NOT_BE_ZERO"
  show CREATE_ACCOUNT_ID_MUST_NOT_BE_INT_MAX = "CREATE_ACCOUNT_ID_MUST_NOT_BE_INT_MAX"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_FLAGS = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_FLAGS"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_128 = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_128"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_64 = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_64"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_32 = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_USER_DATA_32"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_LEDGER = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_LEDGER"
  show CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_CODE = "CREATE_ACCOUNT_EXISTS_WITH_DIFFERENT_CODE"
  show CREATE_ACCOUNT_EXISTS = "CREATE_ACCOUNT_EXISTS"
  show CREATE_ACCOUNT_FLAGS_ARE_MUTUALLY_EXCLUSIVE = "CREATE_ACCOUNT_FLAGS_ARE_MUTUALLY_EXCLUSIVE"
  show CREATE_ACCOUNT_DEBITS_PENDING_MUST_BE_ZERO = "CREATE_ACCOUNT_DEBITS_PENDING_MUST_BE_ZERO"
  show CREATE_ACCOUNT_DEBITS_POSTED_MUST_BE_ZERO = "CREATE_ACCOUNT_DEBITS_POSTED_MUST_BE_ZERO"
  show CREATE_ACCOUNT_CREDITS_PENDING_MUST_BE_ZERO = "CREATE_ACCOUNT_CREDITS_PENDING_MUST_BE_ZERO"
  show CREATE_ACCOUNT_CREDITS_POSTED_MUST_BE_ZERO = "CREATE_ACCOUNT_CREDITS_POSTED_MUST_BE_ZERO"
  show CREATE_ACCOUNT_LEDGER_MUST_NOT_BE_ZERO = "CREATE_ACCOUNT_LEDGER_MUST_NOT_BE_ZERO"
  show CREATE_ACCOUNT_CODE_MUST_NOT_BE_ZERO = "CREATE_ACCOUNT_CODE_MUST_NOT_BE_ZERO"
  show CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS = "CREATE_ACCOUNT_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS"

newtype CreateTransferResult = CreateTransferResult Word32 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show CreateTransferResult where
  show CREATE_TRANSFER_OK = "CREATE_TRANSFER_OK"
  show CREATE_TRANSFER_LINKED_EVENT_FAILED = "CREATE_TRANSFER_LINKED_EVENT_FAILED"
  show CREATE_TRANSFER_LINKED_EVENT_CHAIN_OPEN = "CREATE_TRANSFER_LINKED_EVENT_CHAIN_OPEN"
  show CREATE_TRANSFER_IMPORTED_EVENT_EXPECTED = "CREATE_TRANSFER_IMPORTED_EVENT_EXPECTED"
  show CREATE_TRANSFER_IMPORTED_EVENT_NOT_EXPECTED = "CREATE_TRANSFER_IMPORTED_EVENT_NOT_EXPECTED"
  show CREATE_TRANSFER_TIMESTAMP_MUST_BE_ZERO = "CREATE_TRANSFER_TIMESTAMP_MUST_BE_ZERO"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_OUT_OF_RANGE = "CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_OUT_OF_RANGE"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE = "CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_ADVANCE"
  show CREATE_TRANSFER_RESERVED_FLAG = "CREATE_TRANSFER_RESERVED_FLAG"
  show CREATE_TRANSFER_ID_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_ID_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_ID_MUST_NOT_BE_INT_MAX = "CREATE_TRANSFER_ID_MUST_NOT_BE_INT_MAX"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_FLAGS = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_FLAGS"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_PENDING_ID = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_PENDING_ID"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_TIMEOUT = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_TIMEOUT"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_DEBIT_ACCOUNT_ID = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_DEBIT_ACCOUNT_ID"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CREDIT_ACCOUNT_ID = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CREDIT_ACCOUNT_ID"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_AMOUNT = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_AMOUNT"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_128 = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_128"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_64 = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_64"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_32 = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_USER_DATA_32"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_LEDGER = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_LEDGER"
  show CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CODE = "CREATE_TRANSFER_EXISTS_WITH_DIFFERENT_CODE"
  show CREATE_TRANSFER_EXISTS = "CREATE_TRANSFER_EXISTS"
  show CREATE_TRANSFER_ID_ALREADY_FAILED = "CREATE_TRANSFER_ID_ALREADY_FAILED"
  show CREATE_TRANSFER_FLAGS_ARE_MUTUALLY_EXCLUSIVE = "CREATE_TRANSFER_FLAGS_ARE_MUTUALLY_EXCLUSIVE"
  show CREATE_TRANSFER_DEBIT_ACCOUNT_ID_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_DEBIT_ACCOUNT_ID_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_DEBIT_ACCOUNT_ID_MUST_NOT_BE_INT_MAX = "CREATE_TRANSFER_DEBIT_ACCOUNT_ID_MUST_NOT_BE_INT_MAX"
  show CREATE_TRANSFER_CREDIT_ACCOUNT_ID_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_CREDIT_ACCOUNT_ID_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_CREDIT_ACCOUNT_ID_MUST_NOT_BE_INT_MAX = "CREATE_TRANSFER_CREDIT_ACCOUNT_ID_MUST_NOT_BE_INT_MAX"
  show CREATE_TRANSFER_ACCOUNTS_MUST_BE_DIFFERENT = "CREATE_TRANSFER_ACCOUNTS_MUST_BE_DIFFERENT"
  show CREATE_TRANSFER_PENDING_ID_MUST_BE_ZERO = "CREATE_TRANSFER_PENDING_ID_MUST_BE_ZERO"
  show CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_INT_MAX = "CREATE_TRANSFER_PENDING_ID_MUST_NOT_BE_INT_MAX"
  show CREATE_TRANSFER_PENDING_ID_MUST_BE_DIFFERENT = "CREATE_TRANSFER_PENDING_ID_MUST_BE_DIFFERENT"
  show CREATE_TRANSFER_TIMEOUT_RESERVED_FOR_PENDING_TRANSFER = "CREATE_TRANSFER_TIMEOUT_RESERVED_FOR_PENDING_TRANSFER"
  show CREATE_TRANSFER_CLOSING_TRANSFER_MUST_BE_PENDING = "CREATE_TRANSFER_CLOSING_TRANSFER_MUST_BE_PENDING"
  show CREATE_TRANSFER_AMOUNT_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_AMOUNT_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_LEDGER_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_LEDGER_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_CODE_MUST_NOT_BE_ZERO = "CREATE_TRANSFER_CODE_MUST_NOT_BE_ZERO"
  show CREATE_TRANSFER_DEBIT_ACCOUNT_NOT_FOUND = "CREATE_TRANSFER_DEBIT_ACCOUNT_NOT_FOUND"
  show CREATE_TRANSFER_CREDIT_ACCOUNT_NOT_FOUND = "CREATE_TRANSFER_CREDIT_ACCOUNT_NOT_FOUND"
  show CREATE_TRANSFER_ACCOUNTS_MUST_HAVE_THE_SAME_LEDGER = "CREATE_TRANSFER_ACCOUNTS_MUST_HAVE_THE_SAME_LEDGER"
  show CREATE_TRANSFER_TRANSFER_MUST_HAVE_THE_SAME_LEDGER_AS_ACCOUNTS = "CREATE_TRANSFER_TRANSFER_MUST_HAVE_THE_SAME_LEDGER_AS_ACCOUNTS"
  show CREATE_TRANSFER_PENDING_TRANSFER_NOT_FOUND = "CREATE_TRANSFER_PENDING_TRANSFER_NOT_FOUND"
  show CREATE_TRANSFER_PENDING_TRANSFER_NOT_PENDING = "CREATE_TRANSFER_PENDING_TRANSFER_NOT_PENDING"
  show CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_DEBIT_ACCOUNT_ID = "CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_DEBIT_ACCOUNT_ID"
  show CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CREDIT_ACCOUNT_ID = "CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CREDIT_ACCOUNT_ID"
  show CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_LEDGER = "CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_LEDGER"
  show CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CODE = "CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_CODE"
  show CREATE_TRANSFER_EXCEEDS_PENDING_TRANSFER_AMOUNT = "CREATE_TRANSFER_EXCEEDS_PENDING_TRANSFER_AMOUNT"
  show CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_AMOUNT = "CREATE_TRANSFER_PENDING_TRANSFER_HAS_DIFFERENT_AMOUNT"
  show CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_POSTED = "CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_POSTED"
  show CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_VOIDED = "CREATE_TRANSFER_PENDING_TRANSFER_ALREADY_VOIDED"
  show CREATE_TRANSFER_PENDING_TRANSFER_EXPIRED = "CREATE_TRANSFER_PENDING_TRANSFER_EXPIRED"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS = "CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_NOT_REGRESS"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_POSTDATE_DEBIT_ACCOUNT = "CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_POSTDATE_DEBIT_ACCOUNT"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_POSTDATE_CREDIT_ACCOUNT = "CREATE_TRANSFER_IMPORTED_EVENT_TIMESTAMP_MUST_POSTDATE_CREDIT_ACCOUNT"
  show CREATE_TRANSFER_IMPORTED_EVENT_TIMEOUT_MUST_BE_ZERO = "CREATE_TRANSFER_IMPORTED_EVENT_TIMEOUT_MUST_BE_ZERO"
  show CREATE_TRANSFER_DEBIT_ACCOUNT_ALREADY_CLOSED = "CREATE_TRANSFER_DEBIT_ACCOUNT_ALREADY_CLOSED"
  show CREATE_TRANSFER_CREDIT_ACCOUNT_ALREADY_CLOSED = "CREATE_TRANSFER_CREDIT_ACCOUNT_ALREADY_CLOSED"
  show CREATE_TRANSFER_OVERFLOWS_DEBITS_PENDING = "CREATE_TRANSFER_OVERFLOWS_DEBITS_PENDING"
  show CREATE_TRANSFER_OVERFLOWS_CREDITS_PENDING = "CREATE_TRANSFER_OVERFLOWS_CREDITS_PENDING"
  show CREATE_TRANSFER_OVERFLOWS_DEBITS_POSTED = "CREATE_TRANSFER_OVERFLOWS_DEBITS_POSTED"
  show CREATE_TRANSFER_OVERFLOWS_CREDITS_POSTED = "CREATE_TRANSFER_OVERFLOWS_CREDITS_POSTED"
  show CREATE_TRANSFER_OVERFLOWS_DEBITS = "CREATE_TRANSFER_OVERFLOWS_DEBITS"
  show CREATE_TRANSFER_OVERFLOWS_CREDITS = "CREATE_TRANSFER_OVERFLOWS_CREDITS"
  show CREATE_TRANSFER_OVERFLOWS_TIMEOUT = "CREATE_TRANSFER_OVERFLOWS_TIMEOUT"
  show CREATE_TRANSFER_EXCEEDS_CREDITS = "CREATE_TRANSFER_EXCEEDS_CREDITS"
  show CREATE_TRANSFER_EXCEEDS_DEBITS = "CREATE_TRANSFER_EXCEEDS_DEBITS"
...
newtype AccountFilterFlags = AccountFilterFlags Word32 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
accountFilterFlagsName :: AccountFilterFlags -> String
accountFilterFlagsName ACCOUNT_FILTER_DEBITS = "ACCOUNT_FILTER_DEBITS"
accountFilterFlagsName ACCOUNT_FILTER_CREDITS = "ACCOUNT_FILTER_CREDITS"
accountFilterFlagsName ACCOUNT_FILTER_REVERSED = "ACCOUNT_FILTER_REVERSED"

instance Show AccountFilterFlags where
  showsPrec p flags =
    let flagsSet = filter (flags `testFlags`) [ACCOUNT_FILTER_DEBITS, ACCOUNT_FILTER_CREDITS, ACCOUNT_FILTER_REVERSED]
    in  case flagsSet of
          [] -> showString "zeroBits"
          [singleFlag] -> showString (accountFilterFlagsName singleFlag)
...
newtype QueryFilterFlags = QueryFilterFlags Word32 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)

pattern QUERY_FILTER_REVERSED = (#const TB_QUERY_FILTER_REVERSED) :: QueryFilterFlags

{-# complete QUERY_FILTER_REVERSED #-}

queryFilterFlagsName :: QueryFilterFlags -> String
queryFilterFlagsName QUERY_FILTER_REVERSED = "QUERY_FILTER_REVERSED"

instance Show QueryFilterFlags where
  showsPrec p flags =
    let flagsSet = filter (flags `testFlags`) [QUERY_FILTER_REVERSED]
    in  case flagsSet of
          [] -> showString "zeroBits"
          [singleFlag] -> showString (queryFilterFlagsName singleFlag)
          multipleFlags -> showParen (p > 5) $ showString (intercalate ".|." $ map queryFilterFlagsName multipleFlags)
...
newtype Operation = Operation Word8 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show Operation where
  show OPERATION_PULSE = "OPERATION_PULSE"
  show OPERATION_CREATE_ACCOUNTS = "OPERATION_CREATE_ACCOUNTS"
  show OPERATION_CREATE_TRANSFERS = "OPERATION_CREATE_TRANSFERS"
  show OPERATION_LOOKUP_ACCOUNTS = "OPERATION_LOOKUP_ACCOUNTS"
  show OPERATION_LOOKUP_TRANSFERS = "OPERATION_LOOKUP_TRANSFERS"
  show OPERATION_GET_ACCOUNT_TRANSFERS = "OPERATION_GET_ACCOUNT_TRANSFERS"
  show OPERATION_GET_ACCOUNT_BALANCES = "OPERATION_GET_ACCOUNT_BALANCES"
  show OPERATION_QUERY_ACCOUNTS = "OPERATION_QUERY_ACCOUNTS"
  show OPERATION_QUERY_TRANSFERS = "OPERATION_QUERY_TRANSFERS"
  show OPERATION_GET_EVENTS = "OPERATION_GET_EVENTS"

newtype PacketStatus = PacketStatus Word8 deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show PacketStatus where
  show PACKET_OK = "PACKET_OK"
  show PACKET_TOO_MUCH_DATA = "PACKET_TOO_MUCH_DATA"
  show PACKET_CLIENT_EVICTED = "PACKET_CLIENT_EVICTED"
  show PACKET_CLIENT_RELEASE_TOO_LOW = "PACKET_CLIENT_RELEASE_TOO_LOW"
  show PACKET_CLIENT_RELEASE_TOO_HIGH = "PACKET_CLIENT_RELEASE_TOO_HIGH"
  show PACKET_CLIENT_SHUTDOWN = "PACKET_CLIENT_SHUTDOWN"
  show PACKET_INVALID_OPERATION = "PACKET_INVALID_OPERATION"
  show PACKET_INVALID_DATA_SIZE = "PACKET_INVALID_DATA_SIZE"

newtype InitStatus = InitStatus CInt deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show InitStatus where
  show INIT_SUCCESS = "INIT_SUCCESS"
  show INIT_UNEXPECTED = "INIT_UNEXPECTED"
  show INIT_OUT_OF_MEMORY = "INIT_OUT_OF_MEMORY"
  show INIT_ADDRESS_INVALID = "INIT_ADDRESS_INVALID"
  show INIT_ADDRESS_LIMIT_EXCEEDED = "INIT_ADDRESS_LIMIT_EXCEEDED"
  show INIT_SYSTEM_RESOURCES = "INIT_SYSTEM_RESOURCES"
  show INIT_NETWORK_SUBSYSTEM = "INIT_NETWORK_SUBSYSTEM"
...
newtype ClientStatus = ClientStatus CInt deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show ClientStatus where
  show CLIENT_OK = "CLIENT_OK"
  show CLIENT_INVALID = "CLIENT_INVALID"

newtype RegisterLogCallbackStatus = RegisterLogCallbackStatus CInt deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show RegisterLogCallbackStatus where
  show REGISTER_LOG_CALLBACK_SUCCESS = "REGISTER_LOG_CALLBACK_SUCCESS"
  show REGISTER_LOG_CALLBACK_ALREADY_REGISTERED = "REGISTER_LOG_CALLBACK_ALREADY_REGISTERED"
  show REGISTER_LOG_CALLBACK_NOT_REGISTERED = "REGISTER_LOG_CALLBACK_NOT_REGISTERED"

newtype LogLevel = LogLevel CInt deriving (Eq, Ord, Read, Num, Enum, Real, Integral, Storable, Prim, Bits)
...
instance Show LogLevel where
  show LOG_ERR = "LOG_ERR"
  show LOG_WARN = "LOG_WARN"
  show LOG_INFO = "LOG_INFO"
  show LOG_DEBUG = "LOG_DEBUG"
