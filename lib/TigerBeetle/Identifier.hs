...
newtype Id128 a = Id128 Word128 deriving (Eq, Ord, Show, Read, Num, Real, Storable, Prim, Bits)
...
newtype Id64 a = Id64 Word64 deriving (Eq, Ord, Show, Read, Num, Real, Storable, Prim, Bits)
...
newtype Id32 a = Id32 Word32 deriving (Eq, Ord, Show, Read, Num, Real, Storable, Prim, Bits)
